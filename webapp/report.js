var report = (function (document, window) {
    ...
    function drawWeekDayAnalysis() {
        ...
        options.title = "Nombres d'appels";
        var view = new google.visualization.DataView(dataWeekdays);
        view.hideColumns([4,5,6]);
        (new google.visualization.ComboChart(document.getElementById('chart_weekday_nb'))).draw(view, options);

        options.title = "Temps de communication";                
        view = new google.visualization.DataView(dataWeekdays);
        view.hideColumns([1,2,3]);
        (new google.visualization.ComboChart(document.getElementById('chart_weekday_duration'))).draw(view, options);
    };
    ...
    function drawCalendarAnalysis() {
        ...
        options.title = "Temps de communication par jour";
        var view = new google.visualization.DataView(dataDays);
        view.hideColumns([1,2,5]);
        (new google.visualization.LineChart(document.getElementById('chart_daily_duration'))).draw(view, options);
        
        options.title = "Nombre d'appels par jour";
        view = new google.visualization.DataView(dataDays);
        view.hideColumns([3,4,5]);
        (new google.visualization.LineChart(document.getElementById('chart_daily_nb'))).draw(view, options);
    };
